...
func main() {
	...
	webserver.AddHandler("/choosers/create", newWebChooserHandler.Create)
	...
	webserver.AddHandler("/choosers/create/movielist", newWebChooserHandler.CreateChooserMovieList)
